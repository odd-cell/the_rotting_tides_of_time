  ...
  var scenes = {
    fork: {
      ...
      choices: [
        ...
        { emoji: '🔍', label: 'Investigation: Aid Kaelen and Malagant—investigate the bards\' campsite (Gliss and Guile).', next: 'echo_camp', setPath: 'echo' }
      ]
    },
    ...
    conv_echo_success: {
      ...
      choices: [
        ...
        { emoji: '✋', label: 'Armor of Agathys + Mark: Press the mark and pull the corruption out. Kaelen has your back.', next: 'risky_moment', history: { convergenceEntry: 'ES', convergenceChoice: 'RH' } }
      ]
    },
    conv_echo_fell: {
      title: 'The Hollow — The Weaver of Rot',
      ...
      progress: 2,
      choices: [
        { emoji: '✨', label: 'Kaelen marks the Weaver; you Eldritch Blast the opening. Fight together.', next: 'grey_ending', history: { convergenceEntry: 'EM', convergenceChoice: 'GB', ending: 'G' } },
        { emoji: '⚔️', label: 'Kaelen closes in first; you back her up. Fight together.', next: 'grey_ending', history: { convergenceEntry: 'EM', convergenceChoice: 'KS', ending: 'G' }, party: ['grimshaw', 'suki', 'snap', 'skewer'] },
